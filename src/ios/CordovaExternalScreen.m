...
-(void)registerEvents:(CDVInvokedUrlCommand*)command {
    ...
    [center addObserver:self.screenNotificationDelegate selector:@selector(handleScreenConnectNotification:)
                   name:UIScreenDidConnectNotification object:nil];
    [center addObserver:self.screenNotificationDelegate selector:@selector(handleScreenDisconnectNotification:)
...
-(WKWebView*)getWebView {
    if(!self.externalWebView){
        ...
        self.externalWebView = [[WKWebView alloc] initWithFrame:screenBounds configuration:
